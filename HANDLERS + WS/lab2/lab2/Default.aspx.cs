...
namespace lab2
{
    public partial class _Default : Page
    {
        ...
        {
            HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create(String.Format("http://localhost:50722/yyy.ads?ParmA={0}&ParmB={1}",
        ...
        protected void Post_Click(object sender, EventArgs e)
        {
            ...
            HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create("http://localhost:50722/yyy.ads");
        ...
        protected void ERROR_Click(object sender, EventArgs e)
        {
            try
            {
                HttpWebRequest rq = (HttpWebRequest)HttpWebRequest.Create(String.Format("http://localhost:50722/err.ads"));
                rq.Method = "GET";
                HttpWebResponse response = (HttpWebResponse)rq.GetResponse();
                StreamReader sr = new StreamReader(response.GetResponseStream());
                Response.Write(sr.ReadToEnd());
