...
namespace JSONDataProvider
{
    ...
    {
        //private const string PERSON_JSON_PATH = @"C:\phones.json";
        private const string PERSON_JSON_PATH = @"/Users/dianaagapkina/Desktop/PIS-6/6 DI_NINJECT/Lab_3_MVC/Models/phones.json";
